...
class Agent(object):
    def __init__(self, ckpt_dir, alpha, beta, input_dims, tau, gamma=0.99,
        ...
        self.actor = ActorNetwork(alpha, input_dims, layer1_size,
                                  ...
                                  name='Actor', chkpt_dir=self.ckpt_dir)
        self.critic = CriticNetwork(beta, input_dims, layer1_size,
                                    layer2_size, n_actions=n_actions,
                                    name='Critic', chkpt_dir=self.ckpt_dir)

        self.target_actor = ActorNetwork(alpha, input_dims, layer1_size,
                                         layer2_size, n_actions=n_actions,
                                         name='TargetActor', chkpt_dir=self.ckpt_dir)
        self.target_critic = CriticNetwork(beta, input_dims, layer1_size,
                                           layer2_size, n_actions=n_actions,
                                           name='TargetCritic', chkpt_dir=self.ckpt_dir)
