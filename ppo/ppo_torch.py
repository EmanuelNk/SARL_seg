...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
            fc1_dims=256, fc2_dims=256, chkpt_dir='ppo/ckpts'):
        ...
        self.linear_input_size = self.convw * self.convh * 16
        ...
        self.actor = nn.Sequential(
                ...
                nn.ReLU(),
                nn.Flatten(),
                nn.Linear(self.linear_input_size, fc1_dims),
                nn.ReLU(),
    ...
    def learn(self):
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                states_list =  state_arr[batch].tolist()
                states = T.cat(states_list).to(self.actor.device)
